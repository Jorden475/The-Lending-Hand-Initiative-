      ...
      <section className="bg-brand-muted py-16">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 leading-relaxed">
            Through The Lending Hand Initiative, our family has brought the patient and family perspective to the Congressional Black Caucus, Kidney Disease: Improving Global Outcomes (KDIGO) in Ghana, the U.S. Food and Drug Administration (FDA), NephCure Kidney International, the National Organization for Rare Disorders (NORD), and the International Society of Glomerular Disease (ISGD). Tomorrow, we walk to continue building awareness and supporting families affected by kidney disease.
          </p>
        </div>
      </section>
